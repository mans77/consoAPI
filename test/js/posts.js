...
function loadPosts(id) {
    ...
    var output = "";
    const getData = async () =>{
    const response = await fetch(`http://127.0.0.1:5000/users/`+id+`/posts?_limit=${limit}$_page=${pageCount}`);
  ...
  //    <td> <input id="ha" type="checkbox" /> </td>
    ...
    output += `
          ...
          <tr>
              ...
              <td><textarea ondblclick="myFunction()"  class ="text-area">${info.body}</textarea></td>
